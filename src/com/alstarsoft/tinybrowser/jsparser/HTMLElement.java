...
public class HTMLElement extends HTMLNode {
    ...
    public void updateSize() {
        com.alstarsoft.tinybrowser.render.Block b0 = Mapper.get(node);
        if (b0 == null) return;

        com.alstarsoft.tinybrowser.render.Block b = b0.parts.size() == 0 ? b0 : b0.parts.get(0);
        ...
        if (b0.parts.size() == 0) {
            ...
            com.alstarsoft.tinybrowser.render.Line line = null;
    ...
    public JSValue get(String str) {
        ...
        if (str.matches("href|src|target|download|action|enctype|value|checked|selected")) {
    ...
    private void updateNode(String attr, String value) {
        ...
        com.alstarsoft.tinybrowser.render.Block b = Mapper.get(node);
        if (b != null) {
            if (attr.equals("src") && node.tagName.equals("iframe")) {
                ...
                if (b.form == null) {
                    com.alstarsoft.tinybrowser.render.Form form = new com.alstarsoft.tinybrowser.render.Form(b);
                    b.form = form;
                }
            ...
            } else if (attr.equals("value") && b.inputType != com.alstarsoft.tinybrowser.render.Block.Input.NONE) {
                if (b.inputType >= com.alstarsoft.tinybrowser.render.Block.Input.TEXT && b.inputType <= com.alstarsoft.tinybrowser.render.Block.Input.TEXTAREA) {
                ...
                } else if (attr.equals("checked") && b.inputType >= com.alstarsoft.tinybrowser.render.Block.Input.RADIO && b.inputType <= com.alstarsoft.tinybrowser.render.Block.Input.CHECKBOX) {
