...
//                        }
                        ...
                        if (image != null) {
                            ...
                            if (block != null) {
                                ...
                                imgElement.set("naturalWidth", new com.alstarsoft.tinybrowser.jsparser.JSInt(block.background.image.getWidth()));
                                imgElement.set("naturalHeight", new com.alstarsoft.tinybrowser.jsparser.JSInt(block.background.image.getHeight()));
