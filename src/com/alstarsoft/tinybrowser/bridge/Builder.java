...
import com.alstarsoft.tinybrowser.cssparser.CSSParser;
import com.alstarsoft.tinybrowser.cssparser.QuerySelector;
import com.alstarsoft.tinybrowser.cssparser.StyleMap;
import com.alstarsoft.tinybrowser.cssparser.Styles;
...
import com.alstarsoft.tinybrowser.jsparser.HTMLElement;
import com.alstarsoft.tinybrowser.jsparser.HTMLNode;
...
import com.alstarsoft.tinybrowser.render.Form;
import com.alstarsoft.tinybrowser.render.MediaPlayer;
import com.alstarsoft.tinybrowser.render.RoundedBorder;
import com.alstarsoft.tinybrowser.render.Transition;
import com.alstarsoft.tinybrowser.render.TransitionInfo;
import com.alstarsoft.tinybrowser.render.WebDocument;
import com.alstarsoft.tinybrowser.Reader;
...
public class Builder {
    ...
    public void assignDocument(Node node) {
        ...
        if (jsWindow == null) {
            jsWindow = new com.alstarsoft.tinybrowser.jsparser.Window(new com.alstarsoft.tinybrowser.jsparser.Block());
            jsWindow.setDocument(node.document);
            jsWindow.setLocation(baseUrl);
        }
        com.alstarsoft.tinybrowser.jsparser.HTMLDocument jsDocument = (com.alstarsoft.tinybrowser.jsparser.HTMLDocument) jsWindow.get("document");
    ...
    public void processSpecialElement(Node node) {
        if (node.tagName.matches("img|iframe|form")) {
            ...
            com.alstarsoft.tinybrowser.jsparser.JSArray list = (com.alstarsoft.tinybrowser.jsparser.JSArray) ((com.alstarsoft.tinybrowser.jsparser.JSObject) jsWindow.get("document")).get(key);
    ...
    public void initElement(final Block b) {
        ...
        if (node.tagName.equals("form")) {
            ...
            com.alstarsoft.tinybrowser.bridge.Document childDocument = null;
            ...
            if (childDocument != null) {
                ...
                if (childDocument.builder.jsWindow == null) {
                    childDocument.builder.jsWindow = new com.alstarsoft.tinybrowser.jsparser.Window(new com.alstarsoft.tinybrowser.jsparser.Block());
    ...
    public com.alstarsoft.tinybrowser.jsparser.Block compileScript(Node node, String code) {
        Node n = new Node(1);
    ...
    public void compileScript(ScriptElement script) {
        ...
        if (scope == null) {
            ...
            scope.putAll(sc);
            block.scope = scope;
            block.setConsole((com.alstarsoft.tinybrowser.jsparser.Console)scope.get("console"));
        }

        block.setDocument(parser);
        if (jsWindow == null) {
            jsWindow = (com.alstarsoft.tinybrowser.jsparser.Window) Expression.getVar("window", block);
        } else {
            if (jsWindow.get("document") == com.alstarsoft.tinybrowser.jsparser.Undefined.getInstance()) {
                try {
                    Thread.sleep(30);
                } catch (Exception ex) {}
            }
            block.replaceDocumentObject((com.alstarsoft.tinybrowser.jsparser.HTMLDocument)jsWindow.get("document"));
    ...
    public void updateWindowObjects() {
        for (ScriptElement script: scripts) {
            ...
            com.alstarsoft.tinybrowser.jsparser.Window window = (com.alstarsoft.tinybrowser.jsparser.Window) script.getBody().scope.get("window");
    ...
    public void setParentDocument(com.alstarsoft.tinybrowser.jsparser.Block childBlock, com.alstarsoft.tinybrowser.bridge.Document parent) {
        if (parent == null) return;
    ...
    public void setHandlers(Node node) {
        ...
        for (String attr: attrs) {
            if (attr.startsWith("on")) {
                ...
                com.alstarsoft.tinybrowser.jsparser.Function handler = new com.alstarsoft.tinybrowser.jsparser.Function(new Vector<String>(), compileScript(node, code), null);
                com.alstarsoft.tinybrowser.jsparser.Block b = new com.alstarsoft.tinybrowser.jsparser.Block();
                b.scope = scope;
        ...
        if (node.tagName.equals("a")) {
            ...
            if (!documentWrap.asyncImageLoad) {
                ...
                if (res != null && res.type == Resource.Type.IMAGE && res.getFile() != null) {
                    ...
                    imgElement.set("naturalWidth", new com.alstarsoft.tinybrowser.jsparser.JSInt(b.background.image.getWidth()));
                    imgElement.set("naturalHeight", new com.alstarsoft.tinybrowser.jsparser.JSInt(b.background.image.getHeight()));
                    node.fireEvent("render", "load");
                }
            }
        }
    ...
    public void applyStyles(Block b) {
        Node node = b.node;
        if (b instanceof com.alstarsoft.tinybrowser.render.ReplacedBlock || node.nodeType != ELEMENT) return;
        Styles st = StyleMap.getNodeStyles(node);
    ...
    public void resetStyles(Block b, boolean no_update, boolean force) {
        if (b instanceof com.alstarsoft.tinybrowser.render.ReplacedBlock) return;
        ...
        if (!document.no_immediate_apply) {
            ...
            if (!b.special) {
                b.setBackground(new com.alstarsoft.tinybrowser.render.Background());
                b.setBorderWidth(0);
        ...
        if (b.inputType != Block.Input.NONE && force) {
            if (b.inputType == Block.Input.SELECT && b.inputReady) {
                ...
                if (b.background != null) {
                    ...
                    b.background = new com.alstarsoft.tinybrowser.render.Background();
                }
            }
    ...
    public com.alstarsoft.tinybrowser.bridge.Document documentWrap;

    public String baseUrl = "";
    public WebDocument document;
    public CSSParser cssParser;
    public com.alstarsoft.tinybrowser.jsparser.Window jsWindow;
