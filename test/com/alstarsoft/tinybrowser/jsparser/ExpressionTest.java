...
public class ExpressionTest {
   ...
   /**
    ...
    public void testClasses() {
        ...
        Expression exp = Expression.create(jp.getHead());
        System.out.println(((com.alstarsoft.tinybrowser.jsparser.Function)Expression.getVar("Test", exp)).getBody().scope);
        exp.eval();
    }
   ...
   /**
    ...
    public void testConstructorMode() {
        ...
        exp.setSilent(true);
        exp.eval();
        ((com.alstarsoft.tinybrowser.jsparser.JSObject)exp.getValue()).print_proto = true;
        System.out.println(exp.getValue());
        //assertEquals("{__proto__: {y: 2, constructor: {Function}}, x: 1}", exp.getValue().toString());
        ((com.alstarsoft.tinybrowser.jsparser.JSObject)exp.getValue()).print_proto = false;
    }
   ...
   /**
    ...
    public void testYield() {
        ...
        Expression exp = Expression.create(jp.getHead());
        ((com.alstarsoft.tinybrowser.jsparser.Block)exp).is_gen = true;
        for (int i = 1; i <= 3; i++) {
            exp.eval();
            assertEquals(String.valueOf(i), exp.getValue().toString());
            System.out.println("Done: " + ((com.alstarsoft.tinybrowser.jsparser.Block)exp).done);
        }
